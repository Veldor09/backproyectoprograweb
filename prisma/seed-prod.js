/**
 * seed-prod.js — versión compilada del seed para producción.
 * No requiere ts-node. Se ejecuta con: node prisma/seed-prod.js
...
async function main() {
  ...
  if (!existing) {
    ...
    if (existing.role !== 'SUPER_ADMIN') {
      ...
      console.log('ℹ️  Admin ya existe, sin cambios');
    }
  }
  ...
  if (instructorCount === 0) {
    ...
    console.log('ℹ️  Instructores ya existen, sin cambios');
  }
  ...
  if (classCount === 0) {
    ...
    console.log('✅ Clases creadas (Lun–Sáb)');
  } else {
    console.log('ℹ️  Clases ya existen, sin cambios');
  }
